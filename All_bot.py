...
def func(message):
    ...
    # 2D tyan
        ...
        bot.send_message(message.chat.id, text="А у тебя хороший вкус)\n Хочешь узнать какой у меня любимый фильм?",
                         reply_markup=markup)
    elif (message.text == "Конечно хочу"):
        ...
        btn_Yes = types.KeyboardButton("А неплохо, давай)")
        btn_No = types.KeyboardButton("Ну не знаю, на любителя песня")
        markup1.add(btn_Yes, btn_No) 
        bot.send_message(message.chat.id, text="Понравилось?\nЯ могу скунуть ещё)",reply_markup=markup1)
        
    elif (message.text == "А неплохо, давай)"): 
        bot.send_message(message.chat.id, text="Маленький любитель гачи ремиксов, ты мне нравишься)")
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        bot.send_photo(message.chat.id,
                       'http://pv1.narvii.com/uploaded_cover/7760/5cc6792d42567416cd786b3ea721c009705f9dfbr1-320-240_raw.jpg');
    ...
    elif (message.text == "Ну не знаю, на любителя песня"): 
         bot.send_message(message.chat.id, text="Ничего ты не знаешь в музыке, Джон Сноу")
         markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
         bot.send_photo(message.chat.id,
                        'https://tocrypto.ru/content/uploads/2018/12/mem-Ty-nichego-ne-znaesh-Dzhon-Snou.jpg');        
         markup2 = types.ReplyKeyboardMarkup(resize_keyboard=True)
         btn_boy = types.KeyboardButton("Пай - мальчик")
         btn_2d = types.KeyboardButton("2D тяночка")
         btn_hait = types.KeyboardButton("Хейтер")
    ...
    elif (message.text == "Конечно смотрел"):
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    ...
    elif (message.text == "Где твое уважение?"):
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    ...
    elif (message.text == "Низкая самооценка"):
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    ...
    elif (message.text == "В Бикини Боттом"):
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    ...
    elif (message.text == "Неудачи по жизни"):
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    ...
    elif (message.text == "У меня нет друзей"):
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    ...
    elif (message.text == "Все стабильно"):
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    ...
    # good boy
    ...
    elif (message.text == "Дадада!!!!" or message.text == "Даааа 😻"):
        bot.send_photo(message.chat.id,
    ...
    elif (message.text == "Я устал, я ухожу"):
    ...
    elif (message.text == "Дедлайны горят"):
        ...
        bot.send_message(message.chat.id, text="Такой кнопки нет, дружок - пирожок\nБудь внимательнее с выбором ответов)")
